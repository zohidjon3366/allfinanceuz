...
const required=["server.js","index.html","yangiliklar.html","maqola.html","xizmatlar.html","admin/yangiliklar.html","assets/js/news-client.js","data/news.json"];
let failed=false;
...
if(failed)process.exit(1);console.log("Build verification completed. No npm install required. Render Persistent Disk CMS ready.");
